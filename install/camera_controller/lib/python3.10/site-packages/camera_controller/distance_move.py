...
class CameraTransformNode(Node):
    ...
    def depth_callback(self, msg):
        ...
        # Convertir de latitud y longitud a coordenadas UTM
        latitude = 37.4191666
        longitude = -6.0005347
        ...
        # # self.get_logger().info("Test translation point: %s " %  str(self.translation_vector))

        # self.get_logger().info("Point Odomtry: %s " %  str(point_robot_base_frame))
