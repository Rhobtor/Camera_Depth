    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'camera_interface.msg.Obstacles')
            logger.debug(
            ...
            from camera_interface.msg import Camera
...
class Obstacles(metaclass=Metaclass_Obstacles):
    ...
    _fields_and_field_types = {
        ...
        'objects': 'sequence<camera_interface/Camera>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['camera_interface', 'msg'], 'Camera')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'objects' field must be a set or sequence and each value of type 'Camera'"
        self._objects = value
